...
--
-- Name: process_instances process_instances_process_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.process_instances
    ADD CONSTRAINT process_instances_process_id_fkey FOREIGN KEY (process_id) REFERENCES public.processes(id);
...
ALTER TABLE ONLY public.processes
    ADD CONSTRAINT processes_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.entities(id);


--
-- Name: processes processes_organization_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.processes
    ADD CONSTRAINT processes_organization_id_fkey FOREIGN KEY (organization_id) REFERENCES public.entities(id);
...
--
-- Name: schema_versions schema_versions_schema_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.schema_versions
    ADD CONSTRAINT schema_versions_schema_id_fkey FOREIGN KEY (schema_id) REFERENCES public.schemas(id);
