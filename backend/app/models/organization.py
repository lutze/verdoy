...
class Organization(Entity):
    ...
    # Note: In pure entity approach, relationships are handled through properties JSONB
    # No direct relationships needed since all entities are in the same table
